...
load_from = "work_dirs/griffin_50scenes_25m/vehicle-side/sparsecoop_v1-1_r50_448x800_bs2x8_100e_smallLR/iter_34400.pth"
resume_from = None
workflow = [("train", 1)]
...
model = dict(
    ...
    head=dict(
        ...
        instance_bank=dict(
            ...
            embed_dims=embed_dims,
            anchor=f"data/infos/{dataset_prefix}/vehicle-side/griffin_kmeans900.npy",
