...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                project='sparsecoop',
                name=f'v1-4_{dataset_prefix}_{v2x_side}_lr{lr}_bs{batch_size_per_gpu}x{num_gpus}_{num_epochs}e_153CT_woObsDN',
            ),
        ),
    ],
)
load_from = "work_dirs/V2X-Seq-SPD-2hz/vehicle-side/sparsecoop_v1-1_r50_544x960_bs6x8_800e_woDN/iter_23200.pth"
resume_from = None
workflow = [("train", 1)]
...
read_track_query_file_root = (
    f'./data/infos/{dataset_prefix}/infrastructure-side/track_query_eval_dn/'
)
inf_keys = [
