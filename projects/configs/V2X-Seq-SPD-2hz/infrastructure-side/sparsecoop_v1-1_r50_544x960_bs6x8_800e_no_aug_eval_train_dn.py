...
num_cams = 1
train_sample_num = 1521  # * different for every dataset
class_names = [
    "car",
    # "truck",
...
save_track_query_file_root = f'./data/infos/{dataset_prefix}/{v2x_side}/track_query_dn/'
save_dn = True
...
splits_data_file = f"data/split_datas/cooperative-split-data-spd_eval_train.json"
...
train_pipeline = [
    ...
    dict(type="CircleObjectRangeFilter", class_dist_thred=[110] * len(class_names)),
